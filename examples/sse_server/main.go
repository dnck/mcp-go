...
func NewMCPServer() *server.MCPServer {
	...
	//	fmt.Println("new InitializeRequest:", message.String())
	//})
	...
	//	fmt.Println("new CallToolRequest:", message.String())
	//})
...
func handleSendNotification(
	...
	err := s.SendNotificationToClient(
		ctx,
